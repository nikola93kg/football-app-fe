...
import {
  ...
  fetchReferees,
  deleteReferee,
} from "../../redux/actions/refereeActions";
...
function EditReferee() {
  ...
  const { isModalOpen: isModalOpen, itemId: refereeIdToDelete, openModal: handleOpenDeleteModal, closeModal: handleCloseDeleteModal } = useModal();
        ...
        {referees.map((referee) => (
          <li key={referee.id}>
            ...
            <div className="buttons">
              <button className="edit-btn" onClick={() => setEditingReferee(referee)} >
                <BiSolidEditAlt />
              </button>
              <button className="delete-btn" onClick={() => handleOpenDeleteModal(referee.id)} >
                <MdDelete />
              </button>
            </div>
          </li>
